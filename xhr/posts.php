    ...
    if ($s == 'insert_new_post') {
        ...
        if (empty($errors) && $invalid_file == false) {
            ...
            $post_data                = array(
                ...
                'active' => $post_active,
                'is_reel' => $is_reel,
                'call_action_type' => isset($_POST['call_action_type']) ? $_POST['call_action_type'] : '',
                'call_action_type_url' => isset($_POST['call_action_type_url']) ? $_POST['call_action_type_url'] : ''
            );
        ...
        if (!empty($id)) {
            ...
            if ($wo['config']['post_approval'] == 1 && !Wo_IsAdmin()) {
                ...
                if (ob_end_clean() > 0) ob_end_clean();
                header("Content-Encoding: none");
                header("Connection: close");
                ignore_user_abort();
                ob_start();
